...
- **transformations (optional)**: The user is supposed to pass the list of interpolations and aggregations here; more information provided at the end of this documentation.
