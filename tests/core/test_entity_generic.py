...
test_same_tag_entity = EntityFactory(Constants.TAG_ENTITY, TAG_LIST_MULTI_GET[0], None)
test_diff_tag_entity = EntityFactory(Constants.TAG_ENTITY, TAG_LIST_MULTI_GET[0], None)
